...
export function CustomerAnalytics({ toursData }) {
  ...
  const getReferralSourceData = () => {
    ...
    toursData.forEach(tour => {
      ...
      // İngilizce referans kaynaklarını Türkçeye çevirme
      if (source === "website") source = "Web Sitesi";
      if (source === "recommendation") source = "Tavsiye";
      if (source === "walk_in") source = "Doğrudan Başvuru";
